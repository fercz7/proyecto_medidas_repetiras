...
```{r}
modaltura = modaltura = lme4::lmer( altura ~ dia+riego+hongos+dia*riego + (1|planta), REML = T, data = base2, weights = w)
summary( modaltura)
```
...
Modelo que tenemos
$$y=\mu+\beta t+\gamma_i+\omega_k+\alpha_{\gamma_i,\omega_k}+$$
